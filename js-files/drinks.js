fetch("https://script.google.com/macros/s/AKfycbyh2YdXZyrphn6kcaOYVkRB5nnp1_nSjGCLMkUFdpw4PKCpUFmueXSF6ePT9VIClVGp/exec")
  .then(res => res.json())
  .then(data => {
  ...
  .catch(err => console.error("Drinks failed:", err));
